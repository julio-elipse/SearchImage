namespace SearchImage
{
  ...
  {
    public const string IMG_PROG_MSG_INVALID_ARG = "Please provide a directory path and an image filename to start a search";
    ...
    public const string IMG_SEARCH_MSG_PROJECT_FOUND = "Number of projects found and loaded: {0}";
